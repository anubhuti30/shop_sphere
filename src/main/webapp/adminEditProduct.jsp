...
<title>Edit Product | ShopSphere</title>
<style>
...
<div class="wrap">
    <div class="top">
        <div>
            <div class="badge">Product editor</div>
            <h1>Edit product</h1>
            <p>Update listing content, pricing, and inventory.</p>
        </div>
        <div class="actions">
    ...
    <div class="panel">
        <form action="adminUpdateProduct" method="post" id="editProductForm">
            ...
            <div class="grid">
                ...
                <div class="field full">
                    ...
                    <textarea name="description" rows="5"><%=p.getDescription()%></textarea>
                </div>
                <div class="field">
                    <label>Price</label>
                    <input type="number" step="0.01" name="price" value="<%=p.getPrice()%>">
                </div>
                <div class="field">
                    <label>Stock</label>
                ...
                <div class="field full">
                    ...
                    <input type="text" name="imageUrl" value="<%=p.getImageUrl()%>">
                </div>
            </div>
            <div class="actions">
